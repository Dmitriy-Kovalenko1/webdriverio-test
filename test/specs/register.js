...
const email = Math.random() + 'dmitriy@gmail.com';
...
describe('Register page', () => {
    ...
    it('should fill About field', () => {
        ...
        element.setValue('fweklnfe kwefnwleknlA wkfNwkqfnqwf.');
        browser.pause(1000);
    })
    it('should fill My goals field', () => {
        const element = $('form textarea[name="goals"]');
        element.setValue('Iwefb;qwkfnowkefn weknfqekle wfknewlqfnqadada ssfcswcwcv.');
        browser.pause(1000);
    })
